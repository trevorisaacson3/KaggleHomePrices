...
print(paste("RMSE of Testing Set: ", round(sqrt(mean(MSE_testing)), 3)))
```
...
print(paste("Test RMSE of Tree: ", round(sqrt(mean((testing$SalePrice - pred)^2)), 4)))
...
# pred <- predict(output, testing, type = "response")

#rmse <- sqrt(mean((testing$SalePrice - pred)^2))
#rmse
```
